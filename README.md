...
This R script implements the in-silico treatment predictive machine learning using a Random Forest (RF) multi-class classification approach (see Figure 1). 
